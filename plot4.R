...
par(mfrow = c(2,2))
with(df, plot(CompDate, Global_active_power, type = "l", xlab = "", ylab = "Global Active Power"))
with(df, plot(CompDate, Voltage, type = "l", xlab = "datetime", ylab = "Voltage"))
...
with(df, plot(CompDate, Global_reactive_power, type = "l", xlab = "datetime"))
dev.off()